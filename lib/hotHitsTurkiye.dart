...
class HotHitsTurkiye extends StatefulWidget {
  @override
  _HotHitsTurkiyeState createState() => _HotHitsTurkiyeState();
}

class _HotHitsTurkiyeState extends State<HotHitsTurkiye> {
  int seciliSayfa = 0;
