...
class YeniMuzikRadari extends StatefulWidget {
  @override
  _YeniMuzikRadariState createState() => _YeniMuzikRadariState();
}

class _YeniMuzikRadariState extends State<YeniMuzikRadari> {
  int seciliSayfa = 0;
